...
cp /vagrant/distro/ssl/nginx-selfsigned.crt /etc/ssl/certs/sslcert
cp /vagrant/distro/ssl/nginx-selfsigned.key /etc/ssl/certs/sslcert
cp /vagrant/distro/ssl/dhparam.pem /etc/ssl/certs/sslcert
